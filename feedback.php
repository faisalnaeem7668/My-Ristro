      ...
      <a class="navbar-brand" href="user dashboard/main/template/app-profile.php">User Dashboard</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta"><a href="feedback.php" class="nav-link">Feedback</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
			...
			<div class="container">
				<div class="row d-flex align-items-stretch no-gutters">
					<div class="col-md-6 pt-5 px-2 pb-2 p-md-5 order-md-last">
						<h2 class="h4 mb-2 mb-md-5 font-weight-bold">Enter Your Details</h2>
						<form action="feedback.php" method="post">
             
              <div class="form-group">
                <input type="hidden" class="form-control" name="rec" value="myristro10@gmail.com" autocomplete="off">
              </div><br>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Enter Your Email" name="sub" autocomplete="off">
              </div><br>
              <div class="form-group">
                <textarea class="form-control" placeholder="Enter Your Feedback Here" name="msg" autocomplete="off" rows="4"></textarea>
              </div><br>
              <div class="form-group">
                <input type="submit" value="Send Feedback" class="btn btn-danger py-3 px-5">
              </div>
            </form>
            <?php 
if(isset($_POST["rec"]))
...
?>
          ...
          <div class="col-md-12 text-center heading-section ftco-animate">
        	<span class="subheading">Leave Your Feedbacks Here!!</span><br><br><br><br><br><br><br><br><br>
            <h3 class="mb-4">We Will Improve The Services According To Your Feedbacks</h3>
          </div>
        </div>	
