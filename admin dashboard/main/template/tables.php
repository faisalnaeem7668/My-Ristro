        ...
        ***********************************-->
        <div class="header">    
            <div class="header-content clearfix">
                ...
                <img src="newlogoss.png" height="80px" width="240px">
                </div>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
              ...
              <button class="btn btn-primary" type="button"><a href="adduser.php" style='color:white';><b> Add New Admin </b></a></button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="table-responsive">
                                  ...
                                  <?php
                                  include "config.php";
                                  $sql="SELECT * FROM myregister ORDER BY id ASC";
                               ...
                               <td class='delete'><a href='deleteuser.php?id=<?php echo $row["id"]; ?>'><i class='fa fa-trash-o'></i></a></td>
                                            </tr> 
