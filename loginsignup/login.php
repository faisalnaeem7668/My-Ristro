...
{  $email=$_POST["email"];
    ...
    if($conn==true)
    {
    $sql="SELECT * from myregister where email='$email' AND password='$password'";
       ...
       if(mysqli_num_rows($result)>0)
    {
       ...
       {   session_start();
         ...
         header("Location:/myristro/main.php");
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="fp.php" class="signup-image-link">Forget Password</a>
                    </div>
